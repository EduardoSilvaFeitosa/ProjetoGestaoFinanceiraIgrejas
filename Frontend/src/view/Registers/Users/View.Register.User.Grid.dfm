inherited FrmRegUserGrid: TFrmRegUserGrid
  Caption = 'FrmRegUserGrid'
  PixelsPerInch = 96
  TextHeight = 13
      ...
      inherited pnHeader: TPanel
        inherited pnIdentForm: TPanel
          ...
          inherited lbDescForm: TLabel
            Width = 180
            Caption = 'Informa'#231#245'es dos Usu'#225'rios'
            ExplicitWidth = 133
          end
        end
      ...
      inherited pnContent: TPanel
        ...
        inherited pnGridDetalhes: TPanel
          object dbGrdUsers: TDBCtrlGrid
            ...
            TabOrder = 0
            RowCount = 10
            OnClick = dbGrdUsersClick
            OnPaintPanel = dbGrdUsersPaintPanel
