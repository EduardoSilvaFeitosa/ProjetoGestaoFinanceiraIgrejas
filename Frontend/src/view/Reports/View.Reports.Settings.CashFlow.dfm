inherited FrmReportCashFlow: TFrmReportCashFlow
  ...
  inherited spvMessages: TSplitView
    inherited cpMessage: TCardPanel
      inherited CardSucess: TCard
        inherited pnContainerMsg: TPanel
          inherited pnContainerIconDescSucessMsg: TPanel
            inherited lbSucessMsg: TLabel
              Width = 181
            end
          end
        end
